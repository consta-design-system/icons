...
Для корректной работы в сборщике проекта должен быть настроен [`Module Federation`](https://webpack.js.org/concepts/module-federation/). Если используете [`Create React App`](https://create-react-app.dev/docs/getting-started), то всё будет работать из коробки.
